--[[
    Lua Refreshser: https://learnxinyminutes.com/docs/lua/
    How Neovim integrates Lua
      - :help lua-guide
      - (or HTML version): https://neovim.io/doc/user/lua-guide.html

Kickstart Guide:
  Work through and read the rest of the the file init.lua!
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Option to have find file only search in current file buffer
